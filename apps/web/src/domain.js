...
export const INTERESTS = Object.freeze([
  'coffee', 'football', 'music', 'cinema', 'books', 'travel', 'gaming',
  'fitness', 'food', 'art', 'technology', 'languages', 'volunteering', 'nature'
]);

export const RELATIONSHIP_INTENTS = Object.freeze([
  'marriage', 'serious', 'getToKnow', 'unsure'
]);

export const FAITH_IDENTITIES = Object.freeze([
  'muslim', 'muslimBackground', 'convert', 'exploring', 'preferNotSay'
]);

export const FAITH_PRACTICES = Object.freeze([
  'activelyPracticing', 'practicing', 'moderate', 'cultural', 'private'
]);

export const FAITH_IMPORTANCE = Object.freeze([
  'essential', 'important', 'open', 'flexible'
]);

export const LIFESTYLE_TAGS = Object.freeze([
  'prayer', 'ramadan', 'halal', 'noAlcohol', 'noSmoking',
  'family', 'modesty', 'community', 'marriageMinded'
]);
...
export function getInstitutionsByType(type) {
  return INSTITUTIONS
    .filter((institution) => !type || institution.type === type)
    .slice()
