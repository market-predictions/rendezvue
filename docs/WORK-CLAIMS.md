...
| WC-039 | The repository migration set is deployed to the proof project. | Demonstrated | protected workflow evidence including run `30850758553` | Environment remains synthetic-only. |
| WC-040 | Remote Auth and Data API health and controlled PKCE sessions pass. | Demonstrated | protected workflows and issue #41 | Provider SLA and account-restoration operations are unproven. |
...
| WC-061 | Existing-account sign-in/recovery cannot silently create a new Auth account. | Demonstrated in source and artifact validation | PR #55, adapter tests and WP-065 artifact gate | Does not resolve genuine duplicate accounts or mailbox-loss recovery. |
...
| WC-063 | Duplicate-account and mailbox-loss requests can be recorded as service-only audited investigation cases without granting account mutation powers. | Demonstrated locally and remotely | PR #63, 38 pgTAP assertions, issue #62 and protected run `30843828895` | No account merge, Auth/e-mail change or access-restoration action is implemented or approved. |
| WC-064 | Identity evidence can be classified and independently reviewed under case-kind thresholds without executing an account action. | Demonstrated locally and remotely | PR #66, 62 pgTAP assertions, issue #65 and protected run `30850822452` | This is a technical classification/four-eyes contract, not an approved real-world identity policy; account mutation and restoration remain absent. |
